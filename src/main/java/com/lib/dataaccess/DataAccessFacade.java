...
public class DataAccessFacade implements DataAccess {
    ...
    public static final String OUTPUT_DIR = System.getProperty("user.dir")
            + "\\src\\main\\java\\com\\lib\\dataaccess\\storage";
    ...
    public void saveNewCheckoutRecord(CheckoutRecord record) {
        ...
        String key = record.getMember().getMemberId();
    ...
    static void loadCheckoutRecordMap(List<CheckoutRecord> recordList) {
        ...
        recordList.forEach(record -> members.put(record.getMember().getMemberId(), record));
        saveToStorage(StorageType.RECORDS, members);
    }
