...
public class TestData {
    ...
    public void checkoutRecordData() {
        CheckoutRecord record = new CheckoutRecord(allBooks.get(0).getNextAvailableCopy(), LocalDate.now(), LocalDate.now().plusDays(allBooks.get(0).getMaxCheckoutLength()), members.get(0));
        records.add(record);
        DataAccessFacade.loadCheckoutRecordMap(records);
    }
